...
const config: Config = {
  ...
  url: 'https://thijsvdveer.github.io',
  ...
  themeConfig: {
    ...
    colorMode: {
      ...
      disableSwitch: true, // disables the user from switching to light mode
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/company/leadodo/',
            },
            {
              label: 'Discord',
              href: 'https://discord.gg/7AVrA2M2',
            },
            {
              label: 'X',
              href: 'https://x.com/LeadodoAI',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/ThijsvdVeer/',
            },
          ],
        },
      ],
